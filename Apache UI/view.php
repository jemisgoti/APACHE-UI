...
<body>
          ...
          <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-xl">
                <div class="dropdown-menu-inner">
                  <a href="http://localhost/Apache%20UI/howto.php" class="media d-flex align-items-center">
                  ...
                  <a href="http://localhost/Apache%20UI/faq.php" class="media d-flex align-items-center">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a href="hhttps://github.com/jemis67/APACHE-UI/blob/master/LICENSE" class="dropdown-item">UI Update</a>
  ...
  <main>
    <section class="section section-shaped section-lg">
      ...
      <div class="container pt-lg-md" style="padding-top: 0rem !important;">
        <div class="row justify-content-center">
          <div class="col-lg-12">
            <div class="card bg-secondary shadow border-0">
             
              <div class="card-body px-lg-5 py-lg-5" style="padding: 1rem !important;">
  ...
  <table class="sortable">
    ...
    <tr>
      ...
      <tbody>  </tbody>
       ...
       <iframe src="assets/pdf/<?php echo"".$var;?>#toolbar=0" width="100%" height="700px;"></iframe>
      ...
      <div class="row align-items-center justify-content-md-between">
        ...
        <div class="col-md-6">
          <ul class="nav nav-footer justify-content-end">
            ...
            <li class="nav-item">
              <a href="https://github.com/jemis67/APACHEUI/blob/master/LICENSE" class="nav-link" target="_blank">MIT License</a>
            </li>
          </ul>
        </div>
      </div>
